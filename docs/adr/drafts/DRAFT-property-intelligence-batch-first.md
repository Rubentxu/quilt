# ADR-DRAFT: Property Intelligence batch-first y properties como entidades de primera clase
...
- MCP: `quilt_properties_batch` (`quilt_properties_batch_update` removed — grill session 2026-06-11)
