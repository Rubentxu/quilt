# ADR-0022: Template-driven block cards via `template::` + `card-shape::`

> **Renombrado 2026-06-11**: este ADR era `0007-template-driven-block-cards.md` y
> compartía número con el ADR del editor engine. Ahora vive como **0022** para
> evitar la colisión. La decisión semántica no cambió. Las cross-references en
> narrativas que dicen "ADR-0007" apuntando al concepto de template-driven cards
> deben entenderse como **ADR-0022**.
