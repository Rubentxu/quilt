...
use quilt_cognitive::{
    ...
    KnowledgeEvolutionTracker, MentalModelGardener, MorningBriefing, SerendipityEngineTrait,
    TaskScheduler, TreeRagEngineTrait,
};
...
pub struct DefaultCognitiveHandler {
    ...
    /// Serendipity engine.
    serendipity_engine: Option<Arc<SerendipityEngineTrait>>,
    /// Agent memory engine.
    ...
    /// Tree RAG engine.
    tree_rag: Option<Arc<TreeRagEngineTrait>>,
    /// Task scheduler.
...
impl CognitiveHandler for DefaultCognitiveHandler {
    ...
    async fn serendipity(
        ...
        let min_confidence = min_confidence.unwrap_or(0.3) as f32;
