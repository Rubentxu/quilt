//! Argument Cartographer types
//!
//! Defines the type system for mapping argument structures within a page:
//! nodes (claims, evidence, rebuttals), typed edges (supports, refutes, qualifies),
//! and derived structures (consensus zones, detected contradictions).

use quilt_domain::value_objects::Uuid;
use serde::{Deserialize, Serialize};

/// Role of a block in an argument structure.
...
/// Type of relationship between two argument nodes.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "lowercase")]
...
pub struct ArgumentNode {
    ...
    pub block_id: Uuid,
    /// Role of this block in the argument structure.
    pub role: ArgumentRole,
    /// Strength score 0.0–1.0.
    pub strength: f64,
    /// Whether this node is in an "in" position (supporting), "out" (opposing),
    /// or "neutral" position in the argument graph.
    pub position: Position,
}

/// Position of a node in the argument graph.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "lowercase")]
pub enum Position {
    In,
...
/// An edge connecting two argument nodes.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Complete argument map for a page.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
mod tests {
    ...
    #[test]
    fn test_argument_graph_empty() {
        let graph = ArgumentGraph::default();
    ...
    #[test]
    fn test_argument_graph_with_nodes_and_edges() {
