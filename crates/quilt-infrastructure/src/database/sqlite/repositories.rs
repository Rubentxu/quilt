...
impl quilt_domain::repositories::RelationRepository for SqliteRelationRepository {
    ...
    ) -> Result<Vec<quilt_domain::properties::relation::PropertyRelation>, quilt_domain::DomainError>
    {
        ...
        .fetch_all(&self.pool)
        .await
        .map_err(|e| quilt_domain::DomainError::Storage(format!("relation get_by_key: {}", e)))?;
    ...
    ) -> Result<Vec<quilt_domain::properties::relation::PropertyRelation>, quilt_domain::DomainError>
    {
        ...
        .fetch_all(&self.pool)
        .await
        .map_err(|e| quilt_domain::DomainError::Storage(format!("relation get_from: {}", e)))?;
    ...
    async fn insert(
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| quilt_domain::DomainError::Storage(format!("relation insert: {}", e)))?;
    ...
    async fn delete(
        ...
        sqlx::query("DELETE FROM property_relations WHERE id = ?")
            ...
            .execute(&self.pool)
            .await
            .map_err(|e| quilt_domain::DomainError::Storage(format!("relation delete: {}", e)))?;
        Ok(())
    }
}
